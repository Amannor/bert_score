*This is a small fork I did. The small addition is that in case the code deosn't find the number of the layers for a model (in the hardcoded mapping), it queries huggingface. For details, can see [the difference between the branches]([https://github.com/Tiiiger/bert_score/compare/master...Amannor:bert_score:master](https://github.com/Tiiiger/bert_score/compare/master...Amannor:bert_score:default_layers_num))
# BERTScore
